                ...
                <div class="col-12 col-md-4">
                    <div class="coupon-section">
                            ...
                            <form action="" method="post">
                                <input type="text" class="cart__discount" name="coupon_code" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Enter coupon code', 'woocommerce' ); ?>" class="input-text" />
                                <button type="submit" class="cart__btn-theme" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
                            </form>
                            </div>
                        </div>
